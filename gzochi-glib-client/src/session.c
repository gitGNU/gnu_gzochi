...
char *
gzochi_client_common_session_endpoint (gzochi_client_common_session *session)
{
  return session->endpoint;
}

char *
gzochi_client_common_session_hostname (gzochi_client_common_session *session)
{
  return session->hostname;
}

int 
gzochi_client_common_session_port (gzochi_client_common_session *session)
{
  return session->port;
}
...
gzochi_client_common_session_new (void)
{
  gzochi_client_common_session *session = 
...
void 
gzochi_client_common_session_disconnect (gzochi_client_common_session *session)
{
